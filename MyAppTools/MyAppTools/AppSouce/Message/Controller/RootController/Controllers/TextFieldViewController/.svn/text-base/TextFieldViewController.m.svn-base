...
@interface TextFieldViewController () <AccessViewTagProtocol, UITextFieldViewDelegate>
...
- (void)viewDidLoad {
    ...
    UIButton *button         = [[UIButton alloc] initWithFrame:CGRectMake(0, 120, Width, 60.f)];
    button.layer.borderWidth = 0.5f;
    button.enabled           = NO;
