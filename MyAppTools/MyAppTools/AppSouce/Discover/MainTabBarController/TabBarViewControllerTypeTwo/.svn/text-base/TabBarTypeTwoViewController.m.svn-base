...
- (instancetype)init {
    ...
    if (self = [super init]) {
        ...
        @[[[CustomNavigationController alloc] initWithRootViewController:[HomeViewController new] setNavigationBarHidden:YES],
          [[CustomNavigationController alloc] initWithRootViewController:[DiscoverViewController new] setNavigationBarHidden:YES],
          [[CustomNavigationController alloc] initWithRootViewController:[MainViewController new] setNavigationBarHidden:YES],
          [[CustomNavigationController alloc] initWithRootViewController:[MessageViewController new] setNavigationBarHidden:YES],
          [[CustomNavigationController alloc] initWithRootViewController:[MyViewController new] setNavigationBarHidden:YES]];
